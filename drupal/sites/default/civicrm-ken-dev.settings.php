 ...
 */
define( 'CIVICRM_UF_DSN'  , 'mysql://coopdrupal:36a3e3ed44@bc/coop_drupal?new_link=true' );
 ...
 */
global $civicrm_root;
$civicrm_root = '/u4/kens/ki/proj/coop/drupal/modules/civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', './files/templates_c' );
define( 'CIVICRM_UPLOADDIR'          , './files/upload'  );
define( 'CIVICRM_IMAGE_UPLOADDIR'    , './files/persist');
 ...
 *
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://www/coop-drupal' );
define( 'CIVICRM_UF_RESOURCEURL'  , 'http://www/coop-drupal/modules/civicrm' );
define( 'CIVICRM_RESOURCEBASE'    , '/coop-drupal/modules/civicrm' );
define( 'CIVICRM_IMAGE_UPLOADURL' , '/coop-drupal/files/persist' );
...
define( 'CIVICRM_DSN'  , 'mysql://coopdrupal:36a3e3ed44@bc/coop_drupal?new_link=true' );
 ...
 */
define( 'CIVICRM_SMTP_SERVER'  , 'localhost'    );
define( 'CIVICRM_SMTP_PORT'    , 25    );
