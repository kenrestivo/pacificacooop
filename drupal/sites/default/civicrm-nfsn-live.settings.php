 ...
 */
define( 'CIVICRM_UF_DSN'  , 'mysql://coopdrupal:36a3e3ed44@pacsql.db/coop_drupal?new_link=true' );
 ...
 */
global $civicrm_root;
$civicrm_root = '/nfsn/content/paccoop/htdocs/modules/civicrm';
 ...
 *
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://www.pacificacoop.org' );
define( 'CIVICRM_UF_RESOURCEURL'  , 'http://www.pacifiicacoop.org/modules/civicrm' );
define( 'CIVICRM_RESOURCEBASE'    , '/modules/civicrm' );
define( 'CIVICRM_IMAGE_UPLOADURL' , '/files/persist' );
...
define( 'CIVICRM_DSN'  , 'mysql://coopdrupal:36a3e3ed44@pacsql.db/coop_drupal?new_link=true' );
