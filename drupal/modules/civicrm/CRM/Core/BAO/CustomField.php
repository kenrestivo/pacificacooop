...
$GLOBALS['_CRM_CORE_BAO_CUSTOMFIELD']['_dataType'] =  null;
$GLOBALS['_CRM_CORE_BAO_CUSTOMFIELD']['_importFields'] =  null;
...
class CRM_Core_BAO_CustomField extends CRM_Core_DAO_CustomField {
     ...
     */
     function &dataType()
    {
        if (!($GLOBALS['_CRM_CORE_BAO_CUSTOMFIELD']['_dataType'])) {
            $GLOBALS['_CRM_CORE_BAO_CUSTOMFIELD']['_dataType'] = array(
        ...
        return $GLOBALS['_CRM_CORE_BAO_CUSTOMFIELD']['_dataType'];
    }
     ...
     * @static
     */
      function &getFieldsForImport($contactType = 'Individual', $showAll = false) {
        $fields =& CRM_Core_BAO_CustomField::getFields($contactType, $showAll);
     ...
     * @access public
     */
     function getDisplayValue( $value, $id, &$options ) {
        $option     =& $options[$id];
