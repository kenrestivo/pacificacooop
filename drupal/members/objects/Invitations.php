...
date_format(label_printed, "%%a %%m/%%d/%%Y %%l:%%i%%p") 
                        as printed_human 
from invitations where school_year = "%s" group by label_printed order by label_printed', 
		...
		order by total desc',
                ...
                $res .= $co->page->selfURL(
                    array(
                        ...
                        'value' => 
                        sprintf('<img src="%s/images/x-office-spreadsheet.png" alt="Export to Excel Spreadsheet"> Export %s',  
