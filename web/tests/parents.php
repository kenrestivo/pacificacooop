...
print $cp->selfURL('Add New Parent', array('action' => 'new'));
...
//// EDIT AND NEW //////
 case 'new':
 case 'edit':
	 $atdf = new CoopForm(&$cp, 'parents', $none); // NOT the coopView above!

	 $atdf->overrides['families']['fb_linkConstraints'] = 0;
	 array_push($atdf->obj->fb_fieldsToRender, 'family_id');
